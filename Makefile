...
$(LIB_DIR)liboleg.so: murmur3.o oleg.o dump.o logging.o aol.o port_driver.o rehash.o utils.o tree.o lz4.o
	$(CC) $(CFLAGS) $(INCLUDES) -o $(LIB_DIR)liboleg.so murmur3.o logging.o dump.o aol.o oleg.o tree.o lz4.o rehash.o utils.o -fpic -shared $(MATH_LINKER)
